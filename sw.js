const CACHE='nuestro-espacio-v5-9-1-ios-modal-fix';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./app.js','./ios-native.css'];
